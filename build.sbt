...
lazy val root = project.in(file("."))
  .settings(moduleName := "lab-cassandra")
...
lazy val publishSettings = Seq(
  homepage := Some(url("https://github.com/mboogerd/lab-cassandra")),
  licenses := Seq("MIT" -> url("https://opensource.org/licenses/Apache-2.0")),
  scmInfo := Some(ScmInfo(url("https://github.com/mboogerd/lab-cassandra"), "scm:git:git@github.com:mboogerd/lab-cassandra.git")),
